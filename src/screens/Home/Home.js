          ...
          <TouchableOpacity
            ...
            {tem && (
              <View style={styles.viewLocalizacao}>
                <Text style={styles.txtLocalizacao}>
          ...
          <View style={{marginTop: '2%'}}>
            ...
            <View style={{paddingHorizontal: 15}}>
              <FlatList
                ...
                horizontal={true}
                keyExtractor={estabelecimentos =>
                  String(estabelecimentos.idEstabelecimento)
                }
                renderItem={({item: estabelecimento}) => (
                  <TouchableOpacity
                    onPress={() =>
                      navigateToEstabelecimento(
                    ...
                    <View style={styles.farmaProxContainer}>
                      ...
                      <ShimmerPlaceHolder
                        ...
                        autoRun={true}
                        visible={visible}>
                        <Text style={styles.titleProx}>
                          {estabelecimento.nomeEstabelecimento}{' '}
                        </Text>
                        <Text style={styles.subtitleProx}>
                          {estabelecimento.bairroLogEstabelecimento}{' '}
                        </Text>
                      </ShimmerPlaceHolder>
                    </View>
                  </TouchableOpacity>
                    ...
                    <View style={styles.descMedic}>
                      ...
                      <ShimmerPlaceHolder
                        ...
                        <Text style={styles.dosagemMedic}>
                          {medicament.descDosagem} {medicament.tipoDosagem}
                        </Text>
                      </ShimmerPlaceHolder>
                    </View>
                      ...
                      <View style={styles.viewDados}>
                        ...
                        <ShimmerPlaceHolder
                          ...
                          <Text style={styles.subTitle}>
                            1,6 km - R${' '}
                            {estabelecimento.taxaDeEntregaEstabelecimento},00
                          </Text>
                        </ShimmerPlaceHolder>
                      </View>
                    </View>
