  ...
  async function salvarDados(endereco) {
    try {
      ...
      await AsyncStorage.setItem(
        ...
        endereco.complementoLogCliente,
      );
      ...
      await AsyncStorage.setItem('tipoEndereco', endereco.idLocal);
      await AsyncStorage.setItem(
        'idEnderecoCliente',
        endereco.idEnderecoCliente,
      );
          ...
          <TouchableNativeFeedback
            ...
            <View style={styles.viewLocalizacao}>
              ...
              <Text style={{fontSize: 14, color: 'gray'}}>
                Adicione um novo endereço aqui
              </Text>
            </View>
          </TouchableNativeFeedback>

          <TouchableOpacity
            style={styles.touchLocalizacao}
            ...
            <View style={styles.viewLocalizacao}>
              ...
              <Text style={{fontSize: 14, color: 'gray'}}>
                Pressione para usar sua localização atual
              </Text>
            </View>
          </TouchableOpacity>
        </View>
          ...
          renderItem={({item: endereco}) => (
            <View style={styles.enderecosList}>
              <View style={styles.endereco}>
                <TouchableOpacity
                  onPress={() => enderecoPadrao(endereco)}
                  style={{
                    width: '90%',
                    marginBottom: '5%',
                  ...
                  />
                  <Text
                    style={styles.enderecoTxt}
                    key={endereco.idEnderecoCliente}>
                    {endereco.logCliente}, {endereco.numLogCliente} -{' '}
                    {endereco.bairroLogCliente}, {endereco.cidadeLogCliente}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => salvarDados(endereco)}
        ...
        <Modal
          ...
          <View style={{backgroundColor: 'white', alignItems: 'center'}}>
            <Text style={{marginTop: 20, fontSize: 16}}>
              {logModal}, {numLogModal} - {bairroLogModal}, {cidadeLogModal}
            </Text>

            <View style={{flexDirection: 'row'}}>
              <View style={{width: '35%', borderRadius: 50, marginTop: 20}}>
                <Button
                  onPress={navigateToEditarEndereco}
