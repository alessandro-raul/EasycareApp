...
import { StatusBar, Text, View, StyleSheet, Image, Alert, ScrollView, ActivityIndicator, TouchableWithoutFeedback, TextInput } from 'react-native';
        ...
        <>
            ...
            <ScrollView style={styles.fundo}>
                ...
                <View style={styles.form}>
                    ...
                    <View style={styles.inputContainer}>
                        <TouchableWithoutFeedback>
                            <Icons style={styles.icon} name="clipboard" size={18} color="#333" />
                        </TouchableWithoutFeedback>
                        <TextInput
                            style={styles.input}
                            placeholderTextColor="#666"
                    ...
                    <View style={styles.inputContainer}>
                        <TouchableWithoutFeedback>
                            <Icons style={styles.icon} name="smartphone" size={18} color="#333" />
                        </TouchableWithoutFeedback>
                        <TextInput
                            style={styles.input}
                            placeholderTextColor="#666"
