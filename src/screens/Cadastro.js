  ...
  return (
    <View
      ...
      <KeyboardAvoidingView style={styles.fundo}>
        ...
        <Text style={styles.txtLoginTop}>Finalizar cadastro</Text>
        <Text style={styles.txtInsira}>Falta pouco para você concluir!</Text>
