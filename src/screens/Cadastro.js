...
export default function Cadastro({navigation}){
    ...
    async function cadastrarLoginCliente(){
        ...
        */
        ...
        if(validaEmail(data.emailCliente) && validaSenha(data.senhaCliente)){
...
${validaSenha(data.senhaCliente) ? '' : 'Senha inválida, utilize uma senha com no minímo 8 digitos, sem espaços em brancoale.'}`);
        }
